...
const sendConfirmationEmail =  async (options) =>
{
    ...
    content += `<p>Thank you for booking your appointment for Private Dermatologist at the Medical Express Clinic. We look forward to welcoming you.</p>`;
    ...
    const targetForm = `https://londonmedicalclinic.co.uk/medicalexpressclinic/user/form/derma/${options._id}`;
    const target = `https://londonmedicalclinic.co.uk/medicalexpressclinic/user/edit/derma/${options._id}`;
    ...
    content += `<li> Package : ${options.package} </li>`;
    ...
    await sendMail(options.email, 'Private Dermatologist Appointment Confirmation - Medical Express Clinic' , content, event);
...
const sendRegFormEmail =  async (options) =>
{
    ...
    await sendMail(options.email, 'Registration Form for Private Dermatologist Visit - Medical Express Clinic' , content, null);
}
