...
router.post('/addnewbooking', async function(req, res, next) {
    try{
        ...
        let {fullname, bookingDate, bookingTime, phone, email, notes, service, birthDate, gender, address} = req.body
        ...
        const payload =  {fullname, bookingDate, bookingTime, phone, email, notes, service, birthDate, gender, address}
