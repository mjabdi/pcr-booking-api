...
router.post('/addnewbooking', async function(req, res, next) {
    try{
        ...
        let {fullname, bookingDate, bookingTime, phone, email, notes, packageName, gender, birthDate} = req.body
        ...
        const payload =  {fullname, bookingDate, bookingTime, phone, email, notes, packageName, gender, birthDate}
