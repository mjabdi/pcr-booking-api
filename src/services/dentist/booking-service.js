...
router.post('/submitformdata' , async function (req,res,next) {
    ...
    try{
        ...
        await DentistBooking.updateOne({_id: bookingId} , {formData: JSON.stringify(formData)});
        res.status(200).send({status : "OK"});
    }
    catch(err)
    {
...
router.post('/paybooking' , async function (req,res,next) {
    ...
    try{
        ...
        await DentistBooking.updateOne({_id: bookingId} , {paid: true, OTCCharges:price, paidBy: paidBy, corporate: corporate ? corporate : ''});
        res.status(200).send({status : "OK"});
    }
    catch(err)
    {
...
router.post('/unpaybooking' , async function (req,res,next) {
    ...
    try{
        const bookingId = ObjectId(req.query.id);
        await DentistBooking.updateOne({_id: bookingId} , {paid: false, OTCCharges:0, paidBy: '', corporate: ''});
        res.status(200).send({status : "OK"});
    }
    catch(err)
    {
...
router.get('/getshouldrefundscount', async function(req, res, next) {
    try{
        const count = await DentistBooking.countDocuments({deleted : {$eq: true}, deposit: {$gt : 0} })
...
router.get('/getbookingscountbydatestr', async function(req, res, next) {
    ...
    try{
         ...
         const result = await DentistBooking.countDocuments({bookingDate: dateStr , deleted : {$ne : true }, status: 'booked'}).exec();
...
router.get('/getallbookingscountall', async function(req, res, next) {
    ...
    try{
         const result = await DentistBooking.countDocuments({deleted : {$ne : true }}).exec();
         res.status(200).send({status: "OK", count : result});
    }
    catch(err)
    {
...
router.get('/getallbookingscountbydatestr', async function(req, res, next) {
    ...
    try{
         ...
         const result = await DentistBooking.countDocuments({bookingDate: dateStr , deleted : {$ne : true }}).exec();
         res.status(200).send({status: "OK", count : result});
    }
    catch(err)
    {
...
router.get('/getbookingscountbydatestrandtime', async function(req, res, next) {
    ...
    try{
         ...
         const result = await DentistBooking.countDocuments({bookingDate: dateStr , bookingTime: timeStr, deleted : {$ne : true }, status: 'booked'}).exec();
         res.status(200).send({status: "OK", count : result});
    }
    catch(err)
    {
...
router.get('/getallbookingscountbydatestrandtime', async function(req, res, next) {
    ...
    try{
         ...
         const result = await DentistBooking.countDocuments({bookingDate: dateStr , bookingTime: timeStr, deleted : {$ne : true }}).exec();
         res.status(200).send({status: "OK", count : result});
    }
    catch(err)
    {
...
router.get('/getbookingsbydatestrandtime', async function(req, res, next) {
    ...
    try{
        ...
        const result = await DentistBooking.find({bookingDate: dateStr , bookingTime: timeStr, deleted : {$ne : true }, status: 'booked'}).sort({timeStamp:1}).exec();
...
router.get('/getallbookingsbydatestrandtime', async function(req, res, next) {
    ...
    try{
        ...
        const result = await DentistBooking.find({bookingDate: dateStr , bookingTime: timeStr, deleted : {$ne : true }}).sort({timeStamp:1}).exec();
        res.status(200).send({status: "OK", bookings : result});
   }
   catch(err)
   {
...
router.get('/getallbookings', async function(req, res, next) {
    ...
    try{
         const limit = parseInt(req.query.limit) || DEFAULT_LIMIT
         const result = await DentistBooking.find( {deleted : {$ne : true }} ).sort({bookingDate: -1, bookingTimeNormalized: -1}).limit(limit).exec();
         res.status(200).send(result);
    }
    catch(err)
    {
...
router.get('/getdeletedbookings', async function(req, res, next) {
    ...
    try{
        const limit = parseInt(req.query.limit) || DEFAULT_LIMIT
         const result = await DentistBooking.find( {deleted : {$eq : true }} ).sort({bookingDate: -1, bookingTimeNormalized: -1}).limit(limit).exec();
         res.status(200).send(result);
    }
    catch(err)
    {
...
router.get('/gettodaybookings', async function(req, res, next) {
    ...
    try{
        const today = dateformat(new Date(), 'yyyy-mm-dd');
         ...
         const result = await DentistBooking.find({bookingDate : today, deleted : {$ne : true }}).sort({bookingTimeNormalized: 1}).exec();
         res.status(200).send(result);
    }
    catch(err)
    {
...
router.get('/getoldbookings', async function(req, res, next) {
    ...
    try{
        const today = dateformat(new Date(), 'yyyy-mm-dd');
        const limit = parseInt(req.query.limit) || DEFAULT_LIMIT
         const result = await DentistBooking.find({bookingDate : {$lt : today}, deleted : {$ne : true }}).sort({bookingDate: -1, bookingTimeNormalized: -1}).limit(limit).exec();
         res.status(200).send(result);
    }
    catch(err)
    {
...
router.get('/getfuturebookings', async function(req, res, next) {
    ...
    try{
        const today = dateformat(new Date(), 'yyyy-mm-dd');
        const limit = parseInt(req.query.limit) || DEFAULT_LIMIT
         const result = await DentistBooking.find({bookingDate : {$gt : today}, deleted : {$ne : true }}).sort({bookingDate: 1, bookingTimeNormalized: 1}).limit(limit).exec();
         res.status(200).send(result);
    }
    catch(err)
    {
...
router.get('/getrecentbookings', async function(req, res, next) {
    ...
    try{
         const result = await DentistBooking.find({deleted : {$ne : true }}).sort({timeStamp: -1}).limit(10).exec();
         res.status(200).send(result);
    }
    catch(err)
    {
...
router.get('/getrecentbookingsall', async function(req, res, next) {
    ...
    try{
        const limit = parseInt(req.query.limit) || DEFAULT_LIMIT
         const result = await DentistBooking.find({deleted : {$ne : true }}).sort({timeStamp: -1}).limit(limit).exec();
         res.status(200).send(result);
    }
    catch(err)
    {
...
router.post('/bookappointment', async function(req, res, next) {
    ...
    try{
        ...
        const found = await DentistBooking.findOne({email : req.body.email,
...
router.post('/updatebookappointment', async function(req, res, next) {
    ...
    try{
        ...
        const oldBooking = await DentistBooking.findOne({_id : req.body.bookingId});

        await DentistBooking.updateOne({_id : req.body.bookingId}, {...req.body.person});
...
router.post('/updatebookappointmenttime', async function(req, res, next) {
    ...
    try{
        ...
        await DentistBooking.updateOne({_id : req.body.bookingId}, {bookingDate : req.body.bookingDate, bookingTime : req.body.bookingTime, bookingTimeNormalized: NormalizeTime(req.body.bookingTime)});
...
router.post('/changetopatientattended', async function(req, res, next) {
    ...
    try{
        ...
        await DentistBooking.updateOne({_id : req.query.id}, {status : 'patient_attended'});
