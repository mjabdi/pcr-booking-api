...
const getHolidays = async () => {
  ...
  if (!startingHourMonday || !endingHourMonday || !periodMonday) {
    for (
      let now = new Date(
        new Date(new Date().setDate(1)).setHours(12, 0, 0)
      ).getTime();
  ...
  if (!startingHourTuesday || !endingHourTuesday || !periodTuesday) {
    for (
      let now = new Date(
        new Date(new Date().setDate(2)).setHours(12, 0, 0)
      ).getTime();
      now < new Date().getTime() + 1000 * 60 * 60 * 24 * 365;
      now += 1000 * 60 * 60 * 24 * 7
    ) {
  ...
  if (!startingHourWednesday || !endingHourWednesday || !periodWednesday) {
    for (
      let now = new Date(
        new Date(new Date().setDate(3)).setHours(12, 0, 0)
      ).getTime();
      now < new Date().getTime() + 1000 * 60 * 60 * 24 * 365;
      now += 1000 * 60 * 60 * 24 * 7
    ) {
  ...
  if (!startingHourThursday || !endingHourThursday || !periodThursday) {
    for (
      let now = new Date(
        new Date(new Date().setDate(4)).setHours(12, 0, 0)
      ).getTime();
      now < new Date().getTime() + 1000 * 60 * 60 * 24 * 365;
      now += 1000 * 60 * 60 * 24 * 7
    ) {
  ...
  if (!startingHourFriday || !endingHourFriday || !periodFriday) {
    for (
      let now = new Date(
        new Date(new Date().setDate(5)).setHours(12, 0, 0)
      ).getTime();
      now < new Date().getTime() + 1000 * 60 * 60 * 24 * 365;
      now += 1000 * 60 * 60 * 24 * 7
    ) {
  ...
  if (!startingHourSaturday || !endingHourSaturday || !periodSaturday) {
    for (
      let now = new Date(
        new Date(new Date().setDate(6)).setHours(12, 0, 0)
      ).getTime();
      now < new Date().getTime() + 1000 * 60 * 60 * 24 * 365;
      now += 1000 * 60 * 60 * 24 * 7
    ) {
  ...
  if (!startingHourSunday || !endingHourSunday || !periodSunday) {
    for (
      let now = new Date(
        new Date(new Date().setDate(0)).setHours(12, 0, 0)
      ).getTime();
      now < new Date().getTime() + 1000 * 60 * 60 * 24 * 365;
      now += 1000 * 60 * 60 * 24 * 7
    ) {
