...
const faq = [
  ...
  },
  {
    ...
    answer:
      "Clinic staff will explain all the services that we will be delivered to you and their associated costs. the value of your deposit will be deducted from your total bill at the point of payment. ",
  },
  {
...
const sendRefundNotificationEmail =  async (options) =>
{
    ...
    // content += `<img style="margin:10px" src="https://www.gynae-clinic.co.uk/public/design/images/gynae-clinic.png" alt="Gynae Clinic - private clinic London">`;
    content += `<p>Dear ${options.fullname},</p>`;
    content += `<p> We have processed your appointment cancelation with Gynae Clinic : (Ref# : <strong> ${options.bookingRef}</strong>) </p>`;
    ...
    await sendMail(options.email, 'Refund Deposit Notification (Gynae Clinic) - Medical Express Clinic' , content, null);
}
