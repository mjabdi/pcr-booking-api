...
const getDefaultTimeSlots = (date) =>
{
    ...
    if (someDateStr === '2021-04-02' || someDateStr === '2021-04-05' || someDateStr === '2021-05-03' || someDateStr === '2021-05-31' || someDateStr === '2022-01-03')
    {
        results = TIME_SLOTS_WEEKEND;
    }
    ...
    const is23Dec = (dateStr === '2021-12-23' || dateStr === '2021-12-27' || dateStr === '2021-12-28' || dateStr === '2021-12-31' || dateStr === "2022-04-18" || dateStr === '2022-05-02' || dateStr === '2022-06-02' || dateStr === '2022-09-19')
    const isExceptionWeek = (dateStr === '2022-10-03' || dateStr === '2022-10-04' || dateStr === '2022-10-05' || dateStr === '2022-10-06' || dateStr === '2022-10-07' || dateStr === '2022-10-08' || dateStr === '2022-10-09')
